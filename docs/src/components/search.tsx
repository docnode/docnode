...
export function AISearchTrigger() {
  ...
  return (
    <Context value={useMemo(() => ({ chat, open, setOpen }), [chat, open])}>
      ...
      <button
        className={cn(
          "bg-fd-secondary text-fd-muted-foreground fixed bottom-4 z-20 flex h-10 w-24 items-center gap-2 rounded-2xl border px-2 text-sm font-medium shadow-lg transition-[translate,opacity]",
